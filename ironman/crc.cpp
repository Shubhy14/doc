...
/* *****************OUTPUT***********************
psh@psh-VirtualBox:~$ g++ crc.cpp -o a
psh@psh-VirtualBox:~$ ./a

 Enter Frame size: 5

 Enter Frame:1 0 0 1 0
 ...
 CRC bits: 110
 Transmitted Frame: 10010110
 Receiver side : 
 Received Frame: 1 0 0 1 0 1 1 0

 Remainder: 000
 Since Remainder Is 0 Hence Message Transmitted From Sender To Receriver Is Correctpsh@psh-VirtualBox:~$ g++ crc.cpp -o a
 psh@psh-VirtualBox:~$ ./a
 ...
 Transmitted Frame: 10010110
 Receiver side : 
 Received Frame: 1 0 1 1 0 1 1 0
